class QuestionGroupsController < ApplicationController
  ...
  def new
    ...
    render layout: 'surveyor_gui_blank_modified'
  end
  ...
  def create
    ...
    if @question_group.save
      ...
      render :inline => '<div id="cboxQuestionId">'+@question_group.questions.first.id.to_s+'</div>', :layout => 'surveyor_gui_blank_modified'
    else
      @title = "Add Question"
      survey_section_id = question_group_params[:survey_section_id]
      redirect_to :action => 'new', :controller => 'questions', :layout => 'surveyor_gui_blank_modified', :survey_section_id => survey_section_id
    end
  end
  ...
  def update
    ...
    if @question_group.update_attributes(question_group_params)
      render :blank, :layout => 'surveyor_gui_blank_modified'
      ...
      render :action => 'edit', :layout => 'surveyor_gui_blank_modified'
    end
  end
